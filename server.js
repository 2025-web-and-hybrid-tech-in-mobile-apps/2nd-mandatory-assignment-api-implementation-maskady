...
app.post("/login", (req, res) => {
  ...
  // Vérification que dans le body de la requête, il n'y a que 2 champs : username et password
...
app.get("/high-scores", (req, res) => {
  ...
  // Récupération de tous les high score du niveau demandé
  const highScoresFiltered = highScores.filter((highScore) => highScore.level === level);
  // Sachant qu'une page fait 20 éléments, on récupère les 20 éléments de la page demandée
  ...
  // On crée un tableau avec tous ses éléments
